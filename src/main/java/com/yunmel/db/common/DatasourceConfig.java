...
public class DatasourceConfig {
  ...
  public DatasourceConfig(String driverClass, String jdbcUrl, String username, String password) {
    super();
  ...
  public DatasourceConfig(DataBaseType databasetype, String driverClass, String jdbcUrl, String username,
      String password) {
    super();
  ...
  public String toString() {
    return "DatasourceConfig [databasetype=" + databasetype + ", dialectClass=" + dialectClass + ", driverClass="
        + driverClass + ", jdbcUrl=" + jdbcUrl + ", username=" + username + ", password=" + password
        + ", poolPerperties=" + poolPerperties + "]";
  }
}
